const employees = [
      ...
      //... Daha fazla çalışan kaydı burada eklenebilir
    ];
...
function findEmployeeById(employeeId) {
   ...
   function findBySpecialization(specialization) {
    const foundSpec = employees.find(employee => employee.specialization === specialization);
    ...
    if (foundSpec) {
        ...
        document.getElementById('employeesDetails').innerHTML = 'Bu uzmanlığa sahip çalışan bulunamadı.';
    }
}
